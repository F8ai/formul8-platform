            ...
            <div className="mb-6">
              ...
              <div className="block sm:hidden">
                <div className="flex space-x-1 overflow-x-auto pb-2 scrollbar-hide">
                  ...
                  <button
                    onClick={() => window.location.href = `/agent/${agentType}/baseline`}
                    className="flex-shrink-0 px-4 py-2 text-sm font-medium rounded-md whitespace-nowrap text-gray-500 hover:text-gray-700"
                  >
                    Baseline Editor
                  </button>
                  <button
                    onClick={() => window.location.href = `/agent/${agentType}/results`}
                    className="flex-shrink-0 px-4 py-2 text-sm font-medium rounded-md whitespace-nowrap text-gray-500 hover:text-gray-700"
                  >
                    Test Results
                  </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => window.location.href = `/agent/${agentType}/baseline`}>
                  ...
                  <CardContent>
                    ...
                    <div className="text-xs text-gray-500">
                      Click to edit baseline questions
                    </div>
                  </CardContent>
                </Card>
