#!/usr/bin/env python3
"""
Test AstraDB integration for Spectra Agent
"""
import os
import sys
import asyncio
...
async def test_astradb_integration():
    """Test AstraDB integration for spectra agent"""
    print(f"Testing AstraDB integration for spectra agent...")
    
    # Initialize vector store
    vector_store = AstraDBVectorStore("spectra")
    
    # Test document addition
    test_docs = [
        {
            "content": "This is a test document for spectra agent",
            "metadata": {
                "agent_type": "spectra",
                "source": "test",
                "category": "testing"
