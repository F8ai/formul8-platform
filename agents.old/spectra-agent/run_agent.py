#!/usr/bin/env python3
"""
Standalone runner for Spectra Agent
...
import sys
import json
from agent import create_spectra_agent

async def main():
    parser = argparse.ArgumentParser(description='Spectra Agent - Cannabis Lab Analysis')
    ...
    # Initialize agent
    print("🚀 Initializing Spectra Agent...")
    agent = create_spectra_agent()
