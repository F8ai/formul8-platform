#!/usr/bin/env python3
"""
Test AstraDB integration for Operations Agent
"""
import os
import sys
import asyncio
...
async def test_astradb_integration():
    """Test AstraDB integration for operations agent"""
    print(f"Testing AstraDB integration for operations agent...")
    
    # Initialize vector store
    vector_store = AstraDBVectorStore("operations")
    
    # Test document addition
    test_docs = [
        {
            "content": "This is a test document for operations agent",
            "metadata": {
