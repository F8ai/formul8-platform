#!/usr/bin/env python3
"""
Test AstraDB integration for Formulation Agent
"""
import os
import sys
import asyncio
...
async def test_astradb_integration():
    """Test AstraDB integration for formulation agent"""
    print(f"Testing AstraDB integration for formulation agent...")
    
    # Initialize vector store
    vector_store = AstraDBVectorStore("formulation")
    
    # Test document addition
    test_docs = [
        {
            "content": "This is a test document for formulation agent",
            "metadata": {
