#!/usr/bin/env python3
"""
Test AstraDB integration for Marketing Agent
"""
import os
import sys
import asyncio
...
async def test_astradb_integration():
    """Test AstraDB integration for marketing agent"""
    print(f"Testing AstraDB integration for marketing agent...")
    
    # Initialize vector store
    vector_store = AstraDBVectorStore("marketing")
    
    # Test document addition
    test_docs = [
        {
            "content": "This is a test document for marketing agent",
            "metadata": {
