#!/usr/bin/env python3
"""
Test AstraDB integration for Patent Agent
"""
import os
import sys
import asyncio
...
async def test_astradb_integration():
    """Test AstraDB integration for patent agent"""
    print(f"Testing AstraDB integration for patent agent...")
    
    # Initialize vector store
    vector_store = AstraDBVectorStore("patent")
    
    # Test document addition
    test_docs = [
        {
            "content": "This is a test document for patent agent",
            "metadata": {
                "agent_type": "patent",
                "source": "test",
                "category": "testing"
