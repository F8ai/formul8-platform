#!/usr/bin/env python3
"""
Test AstraDB integration for Sourcing Agent
"""
import os
import sys
import asyncio
...
async def test_astradb_integration():
    """Test AstraDB integration for sourcing agent"""
    print(f"Testing AstraDB integration for sourcing agent...")
    
    # Initialize vector store
    vector_store = AstraDBVectorStore("sourcing")
    
    # Test document addition
    test_docs = [
        {
            "content": "This is a test document for sourcing agent",
            "metadata": {
                "agent_type": "sourcing",
                "source": "test",
                "category": "testing"
