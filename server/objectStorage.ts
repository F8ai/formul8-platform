...
export class ObjectStorageService {
  ...
  // Get the private object directory for uploaded files
  ...
  // Generate upload URL for user files
  async getFileUploadURL(fileName: string, mimeType: string): Promise<string> {
